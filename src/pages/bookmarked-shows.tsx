...
const BookmarkedShows: React.FC = () => {
  return (
    <div className="px-4 py-6 flex flex-col gap-6 | md:px-0 md:py-8 md:gap-8">
      ...
      <div>
        <h2 className="text-[20px] font-light md:text-heading-l">Bookmarked Movies</h2>
      </div>
      <div>
        <h2 className="text-[20px] font-light md:text-heading-l">Bookmarked TV Series</h2>
      </div>
    </div>
  );
};
